...
namespace VintageStoryCodeMod1
{
    /// <summary>
    ///     Sample ModSystem.
    /// </summary>
    ...
    internal class Program : ModSystem
    {
        ...
        {
            _capi = capi;
            _capi.RegisterCommand("hello", Lang.Get("playeralias:hello-world-description"), string.Empty, OnChatCommand);
        }
        ...
        {
            _capi.ShowChatMessage(Lang.Get("playeralias:hello-world-text"));
        }
    }
}
